            ...
            <section className="max-w-4xl mx-auto text-center px-6 pt-20 pb-12">
                ...
                <div className="flex items-center justify-center gap-4 mt-10">
                    ...
                    <button
                        ...
                        className={`relative w-14 h-7 rounded-full transition-colors duration-300 ${annual ? 'bg-space-primary' : 'bg-space-border'}`}
                    >
            ...
            <section className="bg-white border-t border-b border-space-border py-20">
                <div className="max-w-4xl mx-auto px-6">
                    <h2 className="text-3xl font-black text-center text-space-text uppercase tracking-tight mb-12">
                        ¿Por qué elegir <span className="text-space-primary">Spacey</span>?
                    </h2>
                    ...
                    {faqs.map((faq, i) => (
                        <div key={i} className="bg-white border border-space-border rounded-2xl overflow-hidden">
                            <button onClick={() => setOpenFaq(openFaq === i ? null : i)} className="w-full flex items-center justify-between px-6 py-5 text-left gap-4">
                                ...
                                <span className={`text-space-primary transition-transform duration-200 flex-shrink-0 ${openFaq === i ? 'rotate-90' : ''}`}>
                                    <ArrowRight size={16} />
                                </span>
                            </button>
                            {openFaq === i && (
                                <div className="px-6 pb-5">
                                    <p className="text-sm text-space-muted leading-relaxed">{faq.a}</p>
                                </div>
                            )}
                        </div>
                    ))}
            ...
            <section className="bg-space-text text-white py-20">
                <div className="max-w-2xl mx-auto text-center px-6">
                    <h2 className="text-4xl font-black uppercase tracking-tight mb-4">
                        Empieza hoy, <span className="text-space-primary">gratis.</span>
                    </h2>
