...
import { Eye, EyeOff, ArrowLeft, ArrowRight, Mail, CalendarCheck } from 'lucide-react';

/**
 * Registro de CLIENTE (role='client'). Distinto de /register (dueños).
 * Crea una cuenta para ver todas sus citas en /client.
 * Las citas se vinculan por email confirmado (ver getCustomerAppointments).
 */
export default function RegisterClientPage() {
    ...
    // Pre-fill si viene del flujo de invitado / panel de cita por token.
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            const { hasSession } = await signup({
                ...
                phone: formData.phone ? normalizePhoneE164(formData.phone) : undefined,
                role: 'client',
            });
            if (hasSession) {
                ...
                <div className="relative w-full max-w-[400px]">
                    <div className="bg-space-card rounded-2xl p-8 shadow-xl border border-space-border text-center">
                        ...
                        <p className="text-sm font-medium text-space-muted mb-6">
                            Enviamos un enlace de confirmación a <strong className="text-space-text">{formData.email}</strong>. Confírmalo para ver tus citas.
                        </p>
                ...
                <div className="bg-space-card rounded-2xl p-7 shadow-xl border border-space-border">
                    <div className="mb-6">
                        ...
                        <p className="text-sm font-medium text-space-muted">
                            Guarda y gestiona todas tus citas en un solo lugar. Gratis.
                        </p>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <div>
                            <label className="input-label">Teléfono <span className="text-space-muted/60 font-normal">(opcional)</span></label>
